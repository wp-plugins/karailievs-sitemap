<?php
	/*
		...
		Plugin URI: https://wordpress.org/plugins/karailievs-sitemap/
		Description: Generates sitemap for spiders.
		Version: 1.0
		Author: Valentin Karailiev
		Author URI: https://wordpress.org/plugins/karailievs-sitemap/
	*/
	...
	<!-- https://wordpress.org/plugins/karailievs-sitemap/ -->
	...
	function ksm_admin_page() {
		...
		$ksm_permission = ksm_permissions();
		if ($ksm_permission == 1) $msg = "Error: there is a problem with <em>sitemap.xml</em>. It doesn't exist or is not writable.";
		elseif ($ksm_permission == 2) $msg = "Error: there is a problem with <em>sitemap-news.xml</em>. It doesn't exist or is not writable.";
		elseif ($ksm_permission == 3) $msg = "Error: there is a problem with <em>sitemap.xml</em>. It doesn't exist or is not writable.<br/>Error: there is a problem with <em>sitemap-news.xml</em>. It doesn't exist or is not writable.";
?>
	<div class="wrap">
<?php	if ($msg) {	?>
